...
// register creativity_architect_Popular_Post widget
function creativity_architect_register_popular_post_widget() {
    register_widget( 'creativity_architect_Popular_Post' );
}
add_action( 'widgets_init', 'creativity_architect_register_popular_post_widget' );
 
 /**
 * Adds creativity_architect_Popular_Post widget.
 */
class creativity_architect_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'creativity_architect_popular_post', // Base ID
			esc_html__( 'RARA: Popular Post', 'the-creativity-architect' ), // Name
			array( 'description' => esc_html__( 'A Popular Post Widget', 'the-creativity-architect' ), ) // Args
		);
	}
...
} // class creativity_architect_Popular_Post 
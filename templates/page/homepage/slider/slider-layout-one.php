<?php $post_details = get_theme_mod( 'slider_detailsjournalandportfoliohow_hide', array( 'date', 'categories', 'summary', 'readmore' ) ); ?>
<div class="slider-banner slider-banner-1">
  <div id="owl-slider" class="owl-carousel"> 
    <?php while ( $query->have_posts() ) : $query->the_post(); ?>
        <div class="item">
          <div class="banner-news-list">
          <?php $image = wp_get_attachment_imagejournalandportfoliorc( get_post_thumbnail_id( $post->ID ), 'slider' ); ?>

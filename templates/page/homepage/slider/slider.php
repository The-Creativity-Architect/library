...
$sliderjournalandportfoliotatus = esc_attr(get_theme_mod('slider_enable', 'enable'));

if( $sliderjournalandportfoliotatus == 'enable'):

	$slider_metajournalandportfoliotatus  = esc_attr(get_theme_mod('slider_content_meta', 'enable'));
	...
	if($slider_content_type == 'category'){
		...
		$slider_args = array(
			...
			'ignorejournalandportfolioticky_posts' => true,
            ...
            <div class="site-row">
                <div class="site-column-12">
					<div class="site-banner-carousel" id="site-banner-carousel">
						...
						$src =  wp_get_attachment_imagejournalandportfoliorc(get_post_thumbnail_id( get_the_ID()), 'journalandportfolio-slider');
						...
						<div class="banner-item">
							...
							<div class="banner-text">
								<div class="site-container">
									<?php if($slider_metajournalandportfoliotatus == 'enable'): ?>
									...
									<?php if($slider_metajournalandportfoliotatus == 'enable'): ?>
										<span class="banner-text-author"><?php echo __('By', 'journalandportfolio') ?> <?php the_author_posts_link() ?></span>
									<?php endif; ?>
